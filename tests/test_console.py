...
class TestConsole(unittest.TestCase):
    """this will test the console code"""

    @classmethod
    def setUpClass(cls):
        """setup for the test itself"""
        cls.consol = HBNBCommand()

    @classmethod
    def teardown(cls):
        """at the end of the test this will tear itself down"""
        del cls.consol
    ...
    def test_emptyline(self):
        """Test empty line input code"""
        with patch('sys.stdout', new=StringIO()) as f:
            self.consol.onecmd("\n")
            self.assertEqual('', f.getvalue())

    def test_quit(self):
        """test quit command input code"""
        with patch('sys.stdout', new=StringIO()) as f:
            self.consol.onecmd("quit")
            self.assertEqual('', f.getvalue())

    def test_create(self):
        """Test create command input code"""
        with patch('sys.stdout', new=StringIO()) as f:
